...
export const metadata: Metadata = {
  title: 'Terms of Service | Freedom Rising USA',
  description: 'Terms of Service for Freedom Rising USA website',
}
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            Freedom Rising USA Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to Freedom Rising USA! These Terms of Service (“Terms”) govern your access to
            and use of our website, services, and platforms (collectively, “Services”), provided by
            Freedom Rising USA For Charity (“we,” “us,” or “our”). By accessing or using our
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of Freedom Rising USA’s mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to Freedom Rising USA are voluntary and non-refundable. By making a
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to Freedom Rising USA are voluntary and non-refundable. No refunds
            will be given due to the nonprofit nature of Freedom Rising USA.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of Freedom Rising USA or its licensors. You agree not to use,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by Freedom Rising USA. We are not responsible for the content, privacy
            policies, or practices of any third-party websites or services. You acknowledge and
            agree that Freedom Rising USA shall not be liable for any damages or loss caused by or
            in connection with your use of any third-party websites or services.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. Freedom Rising USA
            ...
            Freedom Rising USA disclaims all warranties, express or implied, including, but not
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, Freedom Rising USA shall not be liable for any
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless Freedom Rising USA, its officers,
